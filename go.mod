...
require (
	...
	github.com/thanos-io/promql-engine v0.0.0-20250211181629-815830ca3e2e // indirect
...
replace (
	...
	github.com/thanos-io/thanos => github.com/frezes/thanos v0.0.0-20250219031509-186a9979b843
