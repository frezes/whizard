...
require (
	...
	github.com/prometheus/prometheus v0.308.0-rc.1
...
require (
	...
	github.com/thanos-io/objstore v0.0.0-20250804093838-71d60dfee488 // indirect
	github.com/thanos-io/promql-engine v0.0.0-20250731151205-1a520ea6a26d // indirect
